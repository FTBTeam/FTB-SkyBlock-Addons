...
public class CrookRecipe implements Recipe<NoInventory> {
    ...
    public List<ItemWithChance> results;
    public int max;

    public CrookRecipe(ResourceLocation i, String g) {
        this.id = i;
        this.group = g;
    ...
    public RecipeSerializer<?> getSerializer() {
        return ToolsRegistry.CROOK_RECIPE_SERIALIZER.get();
    }

    @Override
    public RecipeType<?> getType() {
        return ToolsRegistry.CROOK_RECIPE_TYPE.get();
    }
